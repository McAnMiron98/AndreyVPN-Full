...
- Search through [existing open and closed GitHub Issues](https://github.com/andreyvpn/andreyvpn-app/issues) for the answer first. If you find a relevant topic, please comment on the issue.
- If none of the issues are relevant, please add a new [issue](https://github.com/andreyvpn/andreyvpn-app/issues/new/choose) following the templates and provide as much relevant information as possible.
...
Please follow our [Go Core Development repository](https://github.com/andreyvpn/andreyvpn-core/main/CONTRIBUTING.m).
...
Assuming you have not built the `andreyvpn-core` and want to use [existing releases](https://github.com/andreyvpn/andreyvpn-core/releases), you should run the following command (based on your target platform):
...
##### build the `andreyvpn-core` from source (Optional)
If you want to build the `andreyvpn-core` from source after `make prepare`, use:
...
We use [flutter_distributor](https://github.com/leanflutter/flutter_distributor) for packaging. [GitHub action](https://github.com/andreyvpn/andreyvpn-app/blob/main/.github/workflows/build.yml) is triggered on every release tag and will create a new GitHub release.
