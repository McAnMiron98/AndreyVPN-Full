package com.andreyvpn.andreyvpn.bg
...
import com.andreyvpn.core.api.v2.config.Protocol
import com.andreyvpn.core.api.v2.hcommon.Empty
import com.andreyvpn.core.api.v2.hcore.CoreClient
import com.andreyvpn.core.api.v2.hcore.SystemInfo
import com.andreyvpn.core.api.v2.hello.HelloClient
import com.andreyvpn.core.api.v2.hello.HelloRequest
import com.andreyvpn.andreyvpn.Application
import com.andreyvpn.andreyvpn.MainActivity
import com.andreyvpn.andreyvpn.R
import com.andreyvpn.andreyvpn.Settings
import com.andreyvpn.andreyvpn.constant.Action
import com.andreyvpn.andreyvpn.constant.Status
//import com.andreyvpn.andreyvpn.utils.CommandClient
import com.andreyvpn.core.libbox.Libbox
import com.andreyvpn.andreyvpn.Application.Companion.notification
import com.andreyvpn.andreyvpn.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "andreyvpn service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "AndreyVPN")
