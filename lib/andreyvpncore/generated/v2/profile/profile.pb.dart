...
import '../andreyvpnoptions/andreyvpn_options.pb.dart' as $8;
...
class ProfileEntity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProfileEntity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'profile'), createEmptyInstance: create)
    ...
    ..aOM<$8.AndreyVPNOptions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overrideAndreyVPNOptions', subBuilder: $8.AndreyVPNOptions.create)
  ...
  factory ProfileEntity({
    ...
    $8.AndreyVPNOptions? overrideAndreyVPNOptions,
  }) {
    ...
    if (overrideAndreyVPNOptions != null) {
      _result.overrideAndreyVPNOptions = overrideAndreyVPNOptions;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(8)
  $8.AndreyVPNOptions get overrideAndreyVPNOptions => $_getN(6);
  @$pb.TagNumber(8)
  set overrideAndreyVPNOptions($8.AndreyVPNOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasOverrideAndreyVPNOptions() => $_has(6);
  @$pb.TagNumber(8)
  void clearOverrideAndreyVPNOptions() => clearField(8);
  @$pb.TagNumber(8)
  $8.AndreyVPNOptions ensureOverrideAndreyVPNOptions() => $_ensure(6);
}
