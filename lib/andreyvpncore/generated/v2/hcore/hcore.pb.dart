...
class ChangeAndreyVPNSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeAndreyVPNSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'hcore'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'andreyvpnSettingsJson')
    ..hasRequiredFields = false
  ;

  ChangeAndreyVPNSettingsRequest._() : super();
  factory ChangeAndreyVPNSettingsRequest({
    $core.String? andreyvpnSettingsJson,
  }) {
    final _result = create();
    if (andreyvpnSettingsJson != null) {
      _result.andreyvpnSettingsJson = andreyvpnSettingsJson;
    }
    return _result;
  }
  factory ChangeAndreyVPNSettingsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ChangeAndreyVPNSettingsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ChangeAndreyVPNSettingsRequest clone() => ChangeAndreyVPNSettingsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeAndreyVPNSettingsRequest copyWith(void Function(ChangeAndreyVPNSettingsRequest) updates) => super.copyWith((message) => updates(message as ChangeAndreyVPNSettingsRequest)) as ChangeAndreyVPNSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ChangeAndreyVPNSettingsRequest create() => ChangeAndreyVPNSettingsRequest._();
  ChangeAndreyVPNSettingsRequest createEmptyInstance() => create();
  static $pb.PbList<ChangeAndreyVPNSettingsRequest> createRepeated() => $pb.PbList<ChangeAndreyVPNSettingsRequest>();
  @$core.pragma('dart2js:noInline')
  static ChangeAndreyVPNSettingsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChangeAndreyVPNSettingsRequest>(create);
  static ChangeAndreyVPNSettingsRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get andreyvpnSettingsJson => $_getSZ(0);
  @$pb.TagNumber(1)
  set andreyvpnSettingsJson($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasAndreyVPNSettingsJson() => $_has(0);
  @$pb.TagNumber(1)
  void clearAndreyVPNSettingsJson() => clearField(1);
}
