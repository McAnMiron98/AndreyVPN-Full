...
class CoreClient extends $grpc.Client {
  ...
  static final _$changeAndreyVPNSettings =
      $grpc.ClientMethod<$0.ChangeAndreyVPNSettingsRequest, $0.CoreInfoResponse>(
          '/hcore.Core/ChangeAndreyVPNSettings',
          ($0.ChangeAndreyVPNSettingsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.CoreInfoResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.CoreInfoResponse> changeAndreyVPNSettings(
      $0.ChangeAndreyVPNSettingsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$changeAndreyVPNSettings, request, options: options);
  }
...
abstract class CoreServiceBase extends $grpc.Service {
  ...
  CoreServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ChangeAndreyVPNSettingsRequest,
            $0.CoreInfoResponse>(
        'ChangeAndreyVPNSettings',
        changeAndreyVPNSettings_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ChangeAndreyVPNSettingsRequest.fromBuffer(value),
        ($0.CoreInfoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StartRequest, $0.CoreInfoResponse>(
        'StartService',
        startService_Pre,
  ...
  $async.Future<$0.CoreInfoResponse> changeAndreyVPNSettings_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ChangeAndreyVPNSettingsRequest> request) async {
    return changeAndreyVPNSettings(call, await request);
  }
  ...
  $async.Future<$0.CoreInfoResponse> changeAndreyVPNSettings(
      $grpc.ServiceCall call, $0.ChangeAndreyVPNSettingsRequest request);
