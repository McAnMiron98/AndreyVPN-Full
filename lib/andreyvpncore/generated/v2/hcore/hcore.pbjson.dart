...
@$core.Deprecated('Use changeAndreyVPNSettingsRequestDescriptor instead')
const ChangeAndreyVPNSettingsRequest$json = const {
  '1': 'ChangeAndreyVPNSettingsRequest',
  '2': const [
    const {'1': 'andreyvpn_settings_json', '3': 1, '4': 1, '5': 9, '10': 'andreyvpnSettingsJson'},
  ],
};

/// Descriptor for `ChangeAndreyVPNSettingsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeAndreyVPNSettingsRequestDescriptor = $convert.base64Decode('ChxDaGFuZ2VIaWRkaWZ5U2V0dGluZ3NSZXF1ZXN0EjIKFWhpZGRpZnlfc2V0dGluZ3NfanNvbhgBIAEoCVITaGlkZGlmeVNldHRpbmdzSnNvbg==');
