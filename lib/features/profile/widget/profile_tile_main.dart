...
class ProfileTileMain extends HookConsumerWidget {
  ...
  static const verifiedLinks = [
    'https://t.me/andreyvpn',
    'https://t.me/andreyvpn_board',
    'https://instagram.com/andreyvpn_com',
    'https://x.com/andreyvpn_com',
    'https://facebook.com/andreyvpn',
  ];
  ...
  IconData _getLinkIcon(String url, [IconData? icon]) {
    ...
    if (host.endsWith('andreyvpn.com')) {
      // return IconData();
    }
