...
import 'package:andreyvpn/features/proxy/data/proxy_repository.dart';
...
ProxyRepository proxyRepository(Ref ref) {
  return ProxyRepositoryImpl(singbox: ref.watch(andreyvpnCoreServiceProvider), client: ref.watch(httpClientProvider));
}
