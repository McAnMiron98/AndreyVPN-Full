...
import 'package:andreyvpn/features/app_update/data/app_update_data_providers.dart';
import 'package:andreyvpn/features/app_update/model/app_update_failure.dart';
...
class AppUpdateNotifier extends _$AppUpdateNotifier with AppLogger {
  ...
  Future<AppUpdateState> check() async {
    loggy.debug("checking for AndreyVPN update");
