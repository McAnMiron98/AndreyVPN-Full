...
import 'package:andreyvpn/utils/validators.dart';
...
abstract class LinkParser {
  static String generateSubShareLink(String url, [String? name]) {
    ...
    // return 'andreyvpn://import/$modifiedUri';
    return '$modifiedUri';
  }

  // protocols schemas
  static const protocols = ['andreyvpn', 'v2ray', 'v2rayn', 'v2rayng', 'clash', 'clashmeta', 'sing-box'];
